...
from gym_fabrikatioRL.envs.core_events import *
...
class SimulationManager:
    ...
    def pop_routing_queue(self):
        ...
        :return: m_idx, j_idx
        """
        return self.__routing_queue.pop(0)

    def pop_failure_routing_queue(self):
        """
        :return: m_idx, o_idx
        """
        return self.__pending_transport_from_failed_machine.pop(0)
    ...
    def start_new_job(self, j_new: int, state: State) -> None:
        ...
        :return: None
        """
        view_index = state.system_free_job_slots.pop(0)
